window.ggsTranslations = {
    en: {
        ...
        expl_intro_text: "The \"Go Green\" movement is much more than a catchy slogan; it is a necessary response to the growing threat of global warming. By integrating sustainable practices into school environments, we can transform awareness into tangible action, ensuring the next generation is equipped to protect our planet.",
        ...
        gallery_title: "Gallery", gallery_subtitle: "Documentation of student environmental cadres, sanitation and water conservation facilities, school flora diversity, and green open space arrangement.",
        gallery_topic_participation: "Active Student Participation (Environmental Cadres)",
        gallery_topic_sanitation: "Sanitation Facilities & Water Conservation",
        gallery_topic_flora: "School Flora Diversity",
        gallery_topic_rth: "Green Open Space & Environmental Layout",
        gallery_photo1_title: "Active Student Participation (Environmental Cadres)", gallery_photo1_desc: "Students actively care for plants and school environment.",
        gallery_photo2_title: "Sanitation Facilities & Water Conservation", gallery_photo2_desc: "Handwashing facilities and water-use awareness in school.",
        gallery_photo3_title: "School Flora Diversity (Area 1)", gallery_photo3_desc: "Varied vegetation supports school biodiversity.",
        gallery_photo4_title: "School Flora Diversity (Area 2)", gallery_photo4_desc: "Trees and plants enrich the green school ecosystem.",
        gallery_photo5_title: "Green Open Space & Environmental Layout (Area 1)", gallery_photo5_desc: "Open green area with organized and clean school landscape.",
        gallery_photo6_title: "Green Open Space & Environmental Layout (Area 2)", gallery_photo6_desc: "School grounds arranged to support comfortable green activities.",
        ...
        dev_raka_chip: "Lead Web Development",
        dev_raka_meta: "XII RPL - 18 Years",
        dev_raka_role: "Lead Web Developer",
        dev_raka_bio: "Built the core website architecture, developed Laravel backend features, and integrated Blade, Tailwind, Vite, calculator, multi-page flow, plus Email and WhatsApp APIs.",
        dev_raka_quote: "\"Technology should help, not harm the environment.\"",
        dev_sinta_chip: "Poster + QA Support",
        dev_sinta_meta: "XII RPL - 18 Years",
        dev_sinta_role: "Poster Designer & QA Tester",
        dev_sinta_bio: "Designed Go Green promotional posters, supported promotion video editing, and tested website features to ensure they run properly.",
        dev_sinta_quote: "\"Technology is only a tool.\"",
        dev_andi_chip: "Video + Social Media",
        dev_andi_meta: "XII RPL - 18 Years",
        dev_andi_role: "Video Editor & Social Campaign",
        dev_andi_bio: "Produced and edited Go Green promotional videos, managed TikTok publication for the campaign, and helped distribute promo content to a wider audience.",
        dev_andi_quote: "\"Small progress every day leads to big success.\"",
        dev_nadia_chip: "Poster Design + UI QA",
        dev_nadia_meta: "XII RPL - 18 Years",
        dev_nadia_role: "Visual Campaign Designer",
        dev_nadia_bio: "Designed Go Green visual campaign posters, ensured visuals stayed aligned with environmental theme and project branding, and tested website interface and features.",
    ...
    id: {
        ...
        expl_intro_text: "Gerakan \"Go Green\" jauh lebih dari sekadar slogan menarik; ini adalah respons penting terhadap ancaman pemanasan global yang terus meningkat. Dengan mengintegrasikan praktik berkelanjutan ke dalam lingkungan sekolah, kita dapat mengubah kesadaran menjadi aksi nyata, memastikan generasi berikutnya siap melindungi planet kita.",
        ...
        gallery_title: "Galeri", gallery_subtitle: "Dokumentasi kader lingkungan siswa, fasilitas sanitasi dan konservasi air, keanekaragaman flora sekolah, serta ruang terbuka hijau dan penataan lingkungan.",
        gallery_topic_participation: "Partisipasi Aktif Siswa (Kader Lingkungan)",
        gallery_topic_sanitation: "Fasilitas Sanitasi & Konservasi Air",
        gallery_topic_flora: "Keanekaragaman Flora Sekolah",
        gallery_topic_rth: "Ruang Terbuka Hijau (RTH) dan Penataan Lingkungan",
        gallery_photo1_title: "Partisipasi Aktif Siswa (Kader Lingkungan)", gallery_photo1_desc: "Siswa aktif merawat tanaman dan lingkungan sekolah.",
        gallery_photo2_title: "Fasilitas Sanitasi & Konservasi Air", gallery_photo2_desc: "Fasilitas cuci tangan dan kesadaran hemat air di sekolah.",
        gallery_photo3_title: "Keanekaragaman Flora Sekolah (Area 1)", gallery_photo3_desc: "Ragam vegetasi mendukung keanekaragaman hayati sekolah.",
        gallery_photo4_title: "Keanekaragaman Flora Sekolah (Area 2)", gallery_photo4_desc: "Pepohonan dan tanaman memperkaya ekosistem hijau sekolah.",
        gallery_photo5_title: "RTH dan Penataan Lingkungan (Area 1)", gallery_photo5_desc: "Area hijau terbuka dengan lanskap sekolah yang tertata.",
        gallery_photo6_title: "RTH dan Penataan Lingkungan (Area 2)", gallery_photo6_desc: "Penataan lingkungan sekolah mendukung aktivitas hijau yang nyaman.",
        ...
        dev_raka_chip: "Koordinator Pengembangan Web",
        dev_raka_meta: "XII RPL - 18 Tahun",
        dev_raka_role: "Pengembang Web Utama",
        dev_raka_bio: "Membangun arsitektur inti website, mengembangkan fitur backend Laravel, serta mengintegrasikan Blade, Tailwind, Vite, kalkulator, multi halaman, dan API Email serta WhatsApp.",
        dev_raka_quote: "\"Teknologi harus membantu, bukan merusak lingkungan.\"",
        dev_sinta_chip: "Poster + Dukungan QA",
        dev_sinta_meta: "XII RPL - 18 Tahun",
        dev_sinta_role: "Desainer Poster & QA Tester",
        dev_sinta_bio: "Mendesain poster promosi Go Green, membantu proses editing video promosi, serta melakukan pengujian fitur website agar berjalan dengan baik.",
        dev_sinta_quote: "\"teknologi hanya alat\"",
        dev_andi_chip: "Video + Media Sosial",
        dev_andi_meta: "XII RPL - 18 Tahun",
        dev_andi_role: "Editor Video & Kampanye Sosial",
        dev_andi_bio: "Membuat dan mengedit video promosi Go Green, mengelola publikasi kampanye di TikTok, serta membantu penyebaran konten promosi agar menjangkau audiens lebih luas.",
        dev_andi_quote: "\"Kemajuan kecil setiap hari membawa kesuksesan besar.\"",
        dev_nadia_chip: "Desain Poster + UI QA",
        dev_nadia_meta: "XII RPL - 18 Tahun",
        dev_nadia_role: "Desainer Visual Kampanye",
        dev_nadia_bio: "Mendesain poster visual kampanye Go Green, memastikan desain selaras dengan tema lingkungan dan branding proyek, serta menguji tampilan dan fitur website.",
