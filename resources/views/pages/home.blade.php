...
<section class="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 pb-6 mb-10">
        <div class="flex flex-col gap-2">
            <h4 class="text-primary font-bold uppercase tracking-widest text-sm" data-i18n="home_mission_label">Our Mission</h4>
            <h2 class="text-slate-900 tracking-tight text-3xl font-bold leading-tight md:text-4xl max-w-[720px]" data-i18n="home_mission_title">What is Go Green School?</h2>
        </div>
        <p class="text-slate-600 text-base leading-normal max-w-[400px]" data-i18n="home_mission_text">
            A school program that promotes environmental awareness, sustainability, and eco-friendly practices in everyday learning and activities.
        </p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-stagger">
        {{-- Card 1 --}}
        <a href="{{ route('about') }}" class="group flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            ...
            <div class="flex flex-col gap-2 flex-1">
                <h3 class="text-slate-900 text-lg font-bold leading-tight" data-i18n="home_card1_title">About Go Green</h3>
                <p class="text-slate-600 text-sm leading-relaxed" data-i18n="home_card1_desc">Learn what Go Green School is and why it matters for our future.</p>
            </div>
        ...
        {{-- Card 2 --}}
        <a href="{{ route('programs') }}" class="group flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            <div class="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-slate-900 transition-colors">
                <span class="material-symbols-outlined text-2xl">recycling</span>
            </div>
            <div class="flex flex-col gap-2 flex-1">
                <h3 class="text-slate-900 text-lg font-bold leading-tight" data-i18n="home_card2_title">Waste Sorting Guide</h3>
                <p class="text-slate-600 text-sm leading-relaxed" data-i18n="home_card2_desc">Step-by-step guide to properly sort organic, inorganic &amp; B3 waste.</p>
            </div>
        ...
        {{-- Card 3 --}}
        <a href="{{ route('learn') }}" class="group flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            <div class="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-slate-900 transition-colors">
                <span class="material-symbols-outlined text-2xl">thermostat</span>
            </div>
            <div class="flex flex-col gap-2 flex-1">
                <h3 class="text-slate-900 text-lg font-bold leading-tight" data-i18n="home_card3_title">Go Green &amp; Climate</h3>
                <p class="text-slate-600 text-sm leading-relaxed" data-i18n="home_card3_desc">Understand the link between Go Green practices and global warming.</p>
            </div>
...
{{-- STATS BANNER --}}
<section class="w-full bg-white border-y border-slate-200 animate-slide-up">
    <div class="mx-auto max-w-7xl px-6 py-12 lg:px-10 flex flex-col md:flex-row gap-8 items-center">
        <div class="flex-1 space-y-4">
            <h3 class="text-2xl md:text-3xl font-bold text-slate-900" data-i18n="home_stats_title">Make an Impact Today</h3>
            <p class="text-slate-600 leading-relaxed" data-i18n="home_stats_text">Join hundreds of schools across Indonesia in the Go Green School movement.</p>
...
<section class="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
        <div>
            ...
            <h2 class="text-3xl font-bold text-slate-900 tracking-tight" data-i18n="news_latest">Latest News</h2>
            <p class="mt-1 text-slate-600" data-i18n="news_latest_sub">Recent updates from Go Green School activities</p>
        </div>
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4 animate-stagger">
        <a href="{{ route('news.show', 'calculator-sampah') }}" class="group flex flex-col rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            ...
            <div class="p-5 flex flex-col grow">
                ...
                <h4 class="text-sm font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors" data-i18n="news1_title">XI RPL Students Launch Classroom Waste Calculator!</h4>
                <p class="text-xs text-slate-600 leading-relaxed grow" data-i18n="news1_summary">Students of class XI RPL successfully developed a digital waste calculator.</p>
        ...
        <a href="{{ route('news.show', 'penanaman-pohon') }}" class="group flex flex-col rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            ...
            <div class="p-5 flex flex-col grow">
                ...
                <h4 class="text-sm font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors" data-i18n="news2_title">Planting 100 Trees in the School Yard</h4>
                <p class="text-xs text-slate-600 leading-relaxed grow" data-i18n="news2_summary">The school community planted 100 fruit and shade trees in a collaborative action.</p>
                <span class="mt-3 text-primary font-bold text-xs flex items-center gap-1" data-i18n="news_read_more">Read More <span class="material-symbols-outlined text-xs">arrow_forward</span></span>
            </div>
        </a>
        <a href="{{ route('news.show', 'kampanye-anti-plastik') }}" class="group flex flex-col rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            ...
            <div class="p-5 flex flex-col grow">
                ...
                <h4 class="text-sm font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors" data-i18n="news3_title">Anti-Plastic Campaign: Waste Reduced by 40%!</h4>
                <p class="text-xs text-slate-600 leading-relaxed grow" data-i18n="news3_summary">Through a month-long campaign, the school succeeded in reducing plastic waste by 40%.</p>
                <span class="mt-3 text-primary font-bold text-xs flex items-center gap-1" data-i18n="news_read_more">Read More <span class="material-symbols-outlined text-xs">arrow_forward</span></span>
            </div>
        </a>
        <a href="{{ route('news.show', 'workshop-b3') }}" class="group flex flex-col rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-all hover:border-primary/50 hover-lift">
            ...
            <div class="p-5 flex flex-col grow">
                ...
                <h4 class="text-sm font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors" data-i18n="news4_title">B3 Waste Management Workshop a Success!</h4>
                <p class="text-xs text-slate-600 leading-relaxed grow" data-i18n="news4_summary">Interactive workshop taught students how to safely handle hazardous waste (B3).</p>
                <span class="mt-3 text-primary font-bold text-xs flex items-center gap-1" data-i18n="news_read_more">Read More <span class="material-symbols-outlined text-xs">arrow_forward</span></span>
            </div>
        </a>
    </div>
...
{{-- CTA BANNER --}}
<section class="w-full bg-background-forest px-6 py-16 animate-slide-up">
