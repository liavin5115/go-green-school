...
<section class="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        {{-- Card 1 --}}
        <a href="{{ route('about') }}" class="group flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm hover:shadow-md transition-all hover:border-primary/50">
