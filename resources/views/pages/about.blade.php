...
<style>
    ...
    .dark .about-hero {
        ...
        background: linear-gradient(130deg, #0f172a 0%, #102215 45%, #1e293b 100%);
    }
    .about-hero-grid {
        position: relative;
        z-index: 2;
...
<section class="about-hero px-6 py-14 lg:px-10">
    ...
    <div class="mx-auto max-w-7xl about-hero-grid">
        <div class="space-y-5 text-center lg:text-left">
            ...
            <h1 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl lg:text-5xl">Go Green School</h1>
            <p class="text-sm leading-relaxed text-slate-700 dark:text-slate-300 sm:text-base lg:text-lg max-w-3xl mx-auto lg:mx-0" data-i18n="desc_intro">
        ...
        <aside class="about-hero-card">
            <h2 class="text-base sm:text-lg font-bold text-slate-900 dark:text-slate-100 mb-3 flex items-center gap-2" data-i18n="desc_why_title">
...
<section class="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10">
    <div class="grid gap-6 md:grid-cols-2 mb-8 animate-stagger">
        ...
        <div class="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-sm h-full hover-lift transition-smooth">
            ...
            <ul class="space-y-2 text-slate-600 dark:text-slate-400 grow">
        ...
        <div class="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-sm h-full hover-lift transition-smooth">
            ...
            <ul class="space-y-3 text-slate-600 dark:text-slate-400 grow">
