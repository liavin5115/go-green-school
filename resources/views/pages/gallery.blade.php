...
<section class="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10">
    <div class="grid gap-6 sm:grid-cols--2 lg:grid-cols-3">
        ...
        <a href="https://ssww-blog.s3.amazonaws.com/blog/wp-content/uploads/earth-day-plant-a-tree1.jpg" target="_blank" class="rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-white dark:bg-slate-900 shadow-sm hover:shadow-md hover:border-primary/50 transition-all group">
        ...
        <a href="https://cleanriver.com/wp-content/uploads/2023/09/kidsandbin2.jpg" target="_blank" class="rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-white dark:bg-slate-900 shadow-sm hover:shadow-md hover:border-primary/50 transition-all group">
