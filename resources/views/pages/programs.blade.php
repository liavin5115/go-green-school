...
<style>
    ...
    .dark .program-apply-shell {
        border-color: #1f2937;
        background: linear-gradient(135deg, #0b2a1d 0%, #0f172a 100%);
    }
    ...
    .dark .program-apply-item {
        border-color: #334155;
        background: rgba(15, 23, 42, 0.75);
    }
    .dark .program-apply-item[open] {
        border-color: #22c55e;
    ...
    .dark .program-apply-list li .material-symbols-outlined {
        color: #4ade80;
    }
</style>
...
<section class="program-hero px-6 py-14 lg:px-10">
    ...
    <div class="mx-auto max-w-7xl program-hero-grid">
        <div class="space-y-5 text-center lg:text-left">
            ...
            <h1 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl lg:text-5xl" data-i18n="program_hero_title">
                How to Implement Go Green School Program at School
            </h1>
            <p class="text-sm leading-relaxed text-slate-700 dark:text-slate-300 sm:text-base max-w-3xl mx-auto lg:mx-0" data-i18n="program_hero_intro">
        ...
        <aside class="program-hero-flow">
            ...
            <div class="space-y-2">
                <div class="program-flow-step">
                    ...
                    <span class="text-sm md:text-base font-semibold text-slate-800 dark:text-slate-200" data-i18n="procedure_materials_title">Materials and Tools:</span>
                </div>
                ...
                <div class="program-flow-step">
                    ...
                    <span class="text-sm md:text-base font-semibold text-slate-800 dark:text-slate-200" data-i18n="procedure_steps_title">Steps:</span>
                </div>
                <div class="program-flow-arrow"><span class="material-symbols-outlined">south</span></div>
                <div class="program-flow-step">
                    <span class="material-symbols-outlined text-primary">school</span>
                    <span class="text-sm md:text-base font-semibold text-slate-800 dark:text-slate-200" data-i18n="program_hero_flow_apply">Implement Go Green Program</span>
                </div>
            </div>
        </aside>
    </div>
...
<section class="mx-auto w-full max-w-7xl px-6 py-12 lg:px-10">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 animate-stagger">
        ...
        <div class="group relative flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm hover:shadow-md hover:border-primary/50 transition-all hover-lift">
            ...
            <p class="text-sm md:text-base leading-relaxed text-slate-600 dark:text-slate-400" data-i18n="{{ $step['key'] }}"></p>
        </div>
        @endforeach
        <div class="group relative flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm hover:shadow-md hover:border-primary/50 transition-all hover-lift lg:col-span-2">
            ...
            <p class="text-sm md:text-base leading-relaxed text-slate-600 dark:text-slate-400" data-i18n="procedure_step7">Make it a habit to sort waste every day and invite friends to do the same.</p>
        </div>
    </div>
    ...
    <div class="program-apply-shell animate-slide-up">
        <h3 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100" data-i18n="program_hero_title">
            How to Implement the Go Green School Program at School
        </h3>
        <p class="mt-2 text-sm md:text-base text-slate-700 dark:text-slate-300" data-i18n="program_apply_intro">
