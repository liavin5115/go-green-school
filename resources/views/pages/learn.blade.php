...
<section class="mx-auto w-full max-w-7xl px-6 py-12 lg:px-10">
    ...
    <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a href="{{ route('join') }}" class="flex items-center justify-center rounded-lg h-11 px-8 bg-primary hover:bg-green-500 transition-colors text-slate-900 font-bold" data-i18n="home_cta_btn">
            Join Now
        </a>
    </div>
</section>
