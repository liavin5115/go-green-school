...
<section class="max-w-4xl mx-auto text-center px-6 mb-20 pt-8">
    ...
    <h1 class="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6 leading-tight" data-i18n="news_title">
        Go Green School News
    </h1>
    <p class="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto" data-i18n="news_tagline">
...
<section class="max-w-7xl mx-auto px-6 lg:px-10">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger">
        ...
        {{-- News Item 1 --}}
        <article class="group bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-primary/20 hover-lift">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-primary transition-colors" data-i18n="news1_title">Siswa XI RPL Luncurkan Kalkulator Sampah Kelas!</h3>
                <p class="text-slate-600 text-sm line-clamp-2 mb-4 leading-relaxed" data-i18n="news1_summary">Sebuah inovasi digital ramah lingkungan hasil kolaborasi siswa RPL untuk membantu tracking jejak karbon harian di area kelas.</p>
        ...
        <article class="group bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-primary/20 hover-lift">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-primary transition-colors" data-i18n="news2_title">Penanaman 100 Pohon di Pekarangan Sekolah</h3>
                <p class="text-slate-600 text-sm line-clamp-2 mb-4 leading-relaxed" data-i18n="news2_summary">Mewujudkan paru-paru sekolah yang lebih sehat dengan aksi nyata penanaman pohon endemik oleh seluruh warga sekolah.</p>
        ...
        <article class="group bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-primary/20 hover-lift">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-primary transition-colors" data-i18n="news3_title">Kampanye Anti-Plastik: Sampah Berkurang 40%!</h3>
                <p class="text-slate-600 text-sm line-clamp-2 mb-4 leading-relaxed" data-i18n="news3_summary">Hasil evaluasi bulanan menunjukkan penurunan signifikan penggunaan plastik sekali pakai di area kantin dan koperasi sekolah.</p>
        ...
        <article class="group bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-primary/20 hover-lift">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-primary transition-colors" data-i18n="news4_title">Workshop Pengelolaan Sampah B3 Sukses!</h3>
                <p class="text-slate-600 text-sm line-clamp-2 mb-4 leading-relaxed" data-i18n="news4_summary">Edukasi mendalam tentang penanganan sampah elektronik dan bahan berbahaya lainnya bagi staf dan siswa tingkat akhir.</p>
        ...
        <article class="group bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-primary/20 hover-lift">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-primary transition-colors" data-i18n="news5_title">Workshop Siswa tentang Pemanasan Global & Aksi Iklim</h3>
                <p class="text-slate-600 text-sm line-clamp-2 mb-4 leading-relaxed" data-i18n="news5_summary">Membekali generasi muda dengan pengetahuan dan langkah taktis menghadapi krisis iklim melalui diskusi interaktif.</p>
        ...
        <article class="group bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-primary/20 hover-lift">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-primary transition-colors" data-i18n="news6_title">Kolaborasi RPL × Matematika Hasilkan Tools Edukasi</h3>
                <p class="text-slate-600 text-sm line-clamp-2 mb-4 leading-relaxed" data-i18n="news6_summary">Integrasi kurikulum yang menghasilkan aplikasi pembelajaran statistik lingkungan yang inovatif dan mudah digunakan.</p>
...
<section class="max-w-7xl mx-auto px-6 lg:px-10 mt-24 mb-32">
    <div class="bg-primary/5 rounded-3xl p-12 lg:p-20 text-center relative overflow-hidden border border-primary/10">
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-6 relative z-10" data-i18n="news_follow">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            ...
            <a href="{{ route('contact') }}" class="inline-flex items-center justify-center h-11 px-8 bg-primary text-slate-900 rounded-lg font-bold shadow-lg shadow-green-500/25 hover:bg-green-500 transition-all">
                Contact Us →
            </a>
        </div>
    </div>
